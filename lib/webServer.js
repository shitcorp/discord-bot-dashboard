...
module.exports = (config) => {
    ...
    // Login Page - Thinking on Turning it into infoboard login button feature.
    app.get('/login', (req, res) => {
        res.render('pages/login')
    });

    //Guest Page when no auto loggin happens.
...
// Checks if user if logged in, If not logged in then direct to information page about Dashboard and more.
const app = express();
